...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{odkpeicTrees/odkSelectBranco.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{odkpeicTrees/odkSelectForm.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{odkpeicTrees/odkSelectQuad.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{odkpeicTrees/odkSelectTree.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{odkpeicTrees/odkSelectGPS.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{odkpeicTrees/odkSelectFotoType.jpg}
...
\begin{subfigure}{.4\textwidth}
  %\centering
  \includegraphics[width=.9\linewidth]{odkpeicTrees/odkSelectNewFoto.jpg}
  %% \caption{Tela de selecão de nomes da equipe}
  %% \label{fig:app1}
\end{subfigure}\hfil
\begin{subfigure}{.4\textwidth}
  %\centering
  \includegraphics[width=.9\linewidth]{odkpeicTrees/odkSelectNewTree.jpg}
